 ...
 * @param dynamicColor Gibt an, ob dynamische Farben aktiviert sind.
 * @param apiKey Die aktuelle Version der App.
 * @param debug Gibt an, ob Debug-Einstellungen aktiviert sind.
...
sealed class SettingsUiEvent {
    ...
    /**
     * Wird ausgelöst, wenn sich der Api Key ändert (z.B. für die Anzeige).
     */
